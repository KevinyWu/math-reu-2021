...
\begin{scope}[scale=1.3]
    ...
    \draw[ultra thick,->] (3) to (0.5, 0.5);
    \draw[ultra thick,->] (1) to (0.5, 0.5);
    \draw[ultra thick,->] (4) to (0, 0.5);
    \draw[ultra thick,->] (1) to (0, 0.5);
    ...
    \draw [rounded corners=15mm,dashed,thick] (2.2,1.6)--(-0.7,-1.2)--(-0.7,1.6)--cycle;
\end{scope}
